...
import dao.JDBCDeplacementDao;
import dao.JDBCUsagerDao;
...
public class Test2 {
    ...
    public static void main(String [] args) throws DaoException{
         ...
         DaoFactoryJDBC factory = (DaoFactoryJDBC) DaoFactory.getDaoFactory(DaoFactory.PersistenceType.JDBC);
         JDBCUsagerDao jud = factory.getUsagerDao();
         JDBCDeplacementDao jdd = factory.getDeplacementDao();
